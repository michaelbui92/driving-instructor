            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-900">5+ Years Experience</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-900">100+ Students Passed</h3>
                    <p className="text-gray-600 mt-1">
                      Successfully helped students pass their driving tests
                    </p>
                  </div>
                </div>
